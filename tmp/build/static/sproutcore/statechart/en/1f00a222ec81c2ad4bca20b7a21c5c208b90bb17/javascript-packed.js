...
}return ret},acceptsKeyPane:YES,classNames:["sc-main"],ariaRole:"application"});SC.State=SC.Object.extend({name:null,parentState:null,historyState:null,initialSubstate:null,substatesAreConcurrent:NO,substates:null,statechart:null,stateIsInitialized:NO,currentSubstates:null,init:function(){this._registeredEventHandlers={};
